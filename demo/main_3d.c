...
SDL_AppResult SDL_AppInit(void** appstate, int argc, char** argv) {
    ...
    HgError vertex_shader_error = hg_file_load_binary("build/test.vert.spv", &vertex_shader, &vertex_shader_size);
    ...
    HgError fragment_shader_error = hg_file_load_binary("build/test.frag.spv", &fragment_shader, &fragment_shader_size);
