...
static const char* buttonName(Button b)
{
    switch (b)
    {
        ...
        case Button_0: return "0"; case Button_1: return "1"; case Button_2: return "2";
        case Button_3: return "3"; case Button_4: return "4"; case Button_5: return "5";
        case Button_6: return "6"; case Button_7: return "7"; case Button_8: return "8";
        case Button_9: return "9";
        case Button_q: return "q"; case Button_w: return "w"; case Button_e: return "e";
        case Button_r: return "r"; case Button_t: return "t"; case Button_y: return "y";
        case Button_u: return "u"; case Button_i: return "i"; case Button_o: return "o";
        case Button_p: return "p";
        case Button_a: return "a"; case Button_s: return "s"; case Button_d: return "d";
        case Button_f: return "f"; case Button_g: return "g"; case Button_h: return "h";
        case Button_j: return "j"; case Button_k: return "k"; case Button_l: return "l";
        case Button_z: return "z"; case Button_x: return "x"; case Button_c: return "c";
        case Button_v: return "v"; case Button_b: return "b"; case Button_n: return "n";
        case Button_m: return "m";
        case Button_semicolon: return ";"; case Button_apostrophe: return "'";
        case Button_comma: return ","; case Button_period: return ".";
        case Button_grave: return "`"; case Button_lbracket: return "[";
        case Button_rbracket: return "]"; case Button_equal: return "=";
        case Button_minus: return "-"; case Button_slash: return "/";
        case Button_backslash: return "\\";
        case Button_up: return "up"; case Button_down: return "down";
        case Button_left: return "left"; case Button_right: return "right";
        case Button_escape: return "escape"; case Button_space: return "space";
        case Button_enter: return "enter"; case Button_backspace: return "backspace";
        case Button_kdelete: return "delete"; case Button_insert: return "insert";
        case Button_tab: return "tab"; case Button_home: return "home";
        case Button_end: return "end"; case Button_pageup: return "pageup";
        case Button_pagedown: return "pagedown";
        case Button_f1: return "f1"; case Button_f2: return "f2"; case Button_f3: return "f3";
        case Button_f4: return "f4"; case Button_f5: return "f5"; case Button_f6: return "f6";
        case Button_f7: return "f7"; case Button_f8: return "f8"; case Button_f9: return "f9";
        case Button_f10: return "f10"; case Button_f11: return "f11"; case Button_f12: return "f12";
        case Button_printscreen: return "printscreen"; case Button_context: return "context";
        case Button_numpad0: return "kp0"; case Button_numpad1: return "kp1";
        case Button_numpad2: return "kp2"; case Button_numpad3: return "kp3";
        case Button_numpad4: return "kp4"; case Button_numpad5: return "kp5";
        case Button_numpad6: return "kp6"; case Button_numpad7: return "kp7";
        case Button_numpad8: return "kp8"; case Button_numpad9: return "kp9";
        case Button_numpaddecimal: return "kp."; case Button_numpaddiv: return "kp/";
        case Button_numpadmul: return "kp*"; case Button_numpadminus: return "kp-";
        case Button_numpadplus: return "kp+"; case Button_numpadenter: return "kpenter";
        case Button_lshift: return "lshift"; case Button_rshift: return "rshift";
        case Button_lctrl: return "lctrl"; case Button_rctrl: return "rctrl";
        case Button_lalt: return "lalt"; case Button_ralt: return "ralt";
        case Button_lsuper: return "lsuper"; case Button_rsuper: return "rsuper";
        case Button_capslock: return "capslock"; case Button_numlock: return "numlock";
        case Button_scrolllock: return "scrolllock"; case Button_pause: return "pause";
        case Button_mouse1: return "mouse1"; case Button_mouse2: return "mouse2";
        case Button_mouse3: return "mouse3"; case Button_mouse4: return "mouse4";
...
static const char* gamepadButtonName(GamepadButton b)
{
    switch (b)
    {
        ...
        case GamepadButton_south: return "south"; case GamepadButton_east: return "east";
        case GamepadButton_west: return "west"; case GamepadButton_north: return "north";
        case GamepadButton_back: return "back"; case GamepadButton_guide: return "guide";
        ...
        case GamepadButton_dpadUp: return "dpadUp"; case GamepadButton_dpadDown: return "dpadDown";
        case GamepadButton_dpadLeft: return "dpadLeft"; case GamepadButton_dpadRight: return "dpadRight";
