 ...
 * aspect is the texture's aspect, must not be HG_TEXTURE_ASPECT_NONE
 ...
 *
 * \param hg The HurdyGurdy context
 ...
 * x, y, and z are the beginning coordinates of the target area
